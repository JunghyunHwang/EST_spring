...
public class Program {
	...
	private static void test() {
		GenericXmlApplicationContext con = new GenericXmlApplicationContext("classpath:com/config/product.xml");
		
		ProductService service = con.getBean("productService", ProductService.class);
